...
if(isset($_POST['submit'])){
   ...
   $insert = mysqli_query($conn, "INSERT INTO `ContactForm`(name, email, number, date ,note) VALUES('$name','$email','$number','$date' ,'$note')") or die('query failed');
   ...
   <div class="container">
      ...
      <div class="row align-items-center">
         ...
         <div class="col-md-6 content">
            ...
            <a href="#contact" class="link-btn link">make appointment</a>
         </div>
...
<section class="contact" id="contact">
   ...
   <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
      ...
      <input type "text" name="note" class="box" required>
...
<section class="footer">
   ...
   <div class="credit"> &copy; copyright @  by <span>mr. web designer</span>  </div>
